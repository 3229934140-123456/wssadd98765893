...
type SortKey = 'name' | 'appointments' | 'arrivalRate' | 'noShowRate' | 'rescheduleRate';
...
const ClinicTable = ({ data }: ClinicTableProps) => {
  ...
  return (
    <div className="content-card">
      <div className="px-6 py-4 border-b border-neutral-100">
        ...
        <p className="text-sm text-neutral-500 mt-0.5">点击表头可排序</p>
      </div>
