...
export const abnormalPatients: AbnormalPatient[] = [
  { id: 'p1', name: '王女士', phone: '138****1234', clinicName: '上海徐汇店', treatmentType: '种植', abnormalType: 'suture_unvisited', abnormalDetail: '术后7天未拆线回访', lastVisitDate: '2024-06-10', daysOverdue: 5, noShowCount: 1, status: 'pending', assignee: '', assigneeStatus: 'undispatched', followUpRecords: [] },
  { id: 'p2', name: '李先生', phone: '139****5678', clinicName: '北京朝阳店', treatmentType: '正畸', abnormalType: 'ortho_overdue', abnormalDetail: '正畸复诊超期8周', lastVisitDate: '2024-04-15', daysOverdue: 62, noShowCount: 2, status: 'pending', assignee: '陈晓红', assigneeStatus: 'dispatched', dispatchedAt: '2026-06-20 10:30:00', followUpRecords: [{ id: 'f1', patientId: 'p2', fromStatus: 'undispatched', toStatus: 'dispatched', operator: '店长', timestamp: '2026-06-20 10:30:00', note: '分配给陈晓红跟进' }] },
  { id: 'p3', name: '张小朋友', phone: '137****9012', clinicName: '深圳南山店', treatmentType: '儿牙', abnormalType: 'no_show_repeat', abnormalDetail: '累计爽约3次', lastVisitDate: '2024-05-20', daysOverdue: 28, noShowCount: 3, status: 'contacted', assignee: '赵雅芝', assigneeStatus: 'processing', dispatchedAt: '2026-06-18 14:20:00', followUpRecords: [{ id: 'f2', patientId: 'p3', fromStatus: 'undispatched', toStatus: 'dispatched', operator: '店长', timestamp: '2026-06-18 14:20:00', note: '分配给赵雅芝' }, { id: 'f3', patientId: 'p3', fromStatus: 'dispatched', toStatus: 'processing', operator: '赵雅芝', timestamp: '2026-06-19 09:15:00', note: '已联系家长，约定下周复诊' }] },
  { id: 'p4', name: '刘女士', phone: '136****3456', clinicName: '成都锦江店', treatmentType: '正畸', abnormalType: 'ortho_overdue', abnormalDetail: '正畸复诊超期7周', lastVisitDate: '2024-04-28', daysOverdue: 49, noShowCount: 1, status: 'pending', assignee: '', assigneeStatus: 'undispatched', followUpRecords: [] },
  { id: 'p5', name: '陈先生', phone: '135****7890', clinicName: '广州天河店', treatmentType: '种植', abnormalType: 'suture_unvisited', abnormalDetail: '术后10天未拆线回访', lastVisitDate: '2024-06-08', daysOverdue: 7, noShowCount: 0, status: 'contacted', assignee: '刘芳芳', assigneeStatus: 'processing', dispatchedAt: '2026-06-19 11:00:00', followUpRecords: [{ id: 'f4', patientId: 'p5', fromStatus: 'undispatched', toStatus: 'dispatched', operator: '店长', timestamp: '2026-06-19 11:00:00', note: '分配给刘芳芳' }, { id: 'f5', patientId: 'p5', fromStatus: 'dispatched', toStatus: 'processing', operator: '刘芳芳', timestamp: '2026-06-19 15:30:00', note: '电话接通，明天下午来拆线' }] },
  { id: 'p6', name: '赵女士', phone: '134****2345', clinicName: '上海浦东店', treatmentType: '牙周', abnormalType: 'no_show_repeat', abnormalDetail: '累计爽约2次', lastVisitDate: '2024-05-15', daysOverdue: 33, noShowCount: 2, status: 'pending', assignee: '', assigneeStatus: 'undispatched', followUpRecords: [] },
  { id: 'p7', name: '孙先生', phone: '133****6789', clinicName: '杭州西湖店', treatmentType: '正畸', abnormalType: 'ortho_overdue', abnormalDetail: '正畸复诊超期9周', lastVisitDate: '2024-04-05', daysOverdue: 72, noShowCount: 3, status: 'pending', assignee: '孙秀英', assigneeStatus: 'dispatched', dispatchedAt: '2026-06-17 09:00:00', followUpRecords: [{ id: 'f6', patientId: 'p7', fromStatus: 'undispatched', toStatus: 'dispatched', operator: '店长', timestamp: '2026-06-17 09:00:00', note: '超期严重，优先跟进' }] },
  { id: 'p8', name: '周女士', phone: '132****0123', clinicName: '北京海淀店', treatmentType: '种植', abnormalType: 'suture_unvisited', abnormalDetail: '术后8天未拆线回访', lastVisitDate: '2024-06-09', daysOverdue: 6, noShowCount: 0, status: 'recovered', assignee: '李雪芳', assigneeStatus: 'completed', dispatchedAt: '2026-06-15 16:00:00', followUpRecords: [{ id: 'f7', patientId: 'p8', fromStatus: 'undispatched', toStatus: 'dispatched', operator: '店长', timestamp: '2026-06-15 16:00:00' }, { id: 'f8', patientId: 'p8', fromStatus: 'dispatched', toStatus: 'processing', operator: '李雪芳', timestamp: '2026-06-16 10:00:00', note: '已联系，明天来拆线' }, { id: 'f9', patientId: 'p8', fromStatus: 'processing', toStatus: 'completed', operator: '李雪芳', timestamp: '2026-06-17 14:00:00', note: '已完成拆线，患者满意' }] },
  { id: 'p9', name: '吴先生', phone: '131****4567', clinicName: '上海徐汇店', treatmentType: '综合', abnormalType: 'no_show_repeat', abnormalDetail: '累计爽约2次', lastVisitDate: '2024-05-25', daysOverdue: 23, noShowCount: 2, status: 'contacted', assignee: '张丽华', assigneeStatus: 'processing', dispatchedAt: '2026-06-19 08:30:00', followUpRecords: [{ id: 'f10', patientId: 'p9', fromStatus: 'undispatched', toStatus: 'dispatched', operator: '店长', timestamp: '2026-06-19 08:30:00' }, { id: 'f11', patientId: 'p9', fromStatus: 'dispatched', toStatus: 'processing', operator: '张丽华', timestamp: '2026-06-20 11:00:00', note: '重新预约下周二' }] },
  { id: 'p10', name: '郑女士', phone: '130****8901', clinicName: '深圳南山店', treatmentType: '正畸', abnormalType: 'ortho_overdue', abnormalDetail: '正畸复诊超期6周+3天', lastVisitDate: '2024-05-01', daysOverdue: 45, noShowCount: 1, status: 'pending', assignee: '', assigneeStatus: 'undispatched', followUpRecords: [] },
  { id: 'p11', name: '冯先生', phone: '188****2233', clinicName: '北京朝阳店', treatmentType: '正畸', abnormalType: 'no_show_repeat', abnormalDetail: '累计爽约4次', lastVisitDate: '2024-04-20', daysOverdue: 58, noShowCount: 4, status: 'pending', assignee: '陈晓红', assigneeStatus: 'dispatched', dispatchedAt: '2026-06-18 15:00:00', followUpRecords: [{ id: 'f12', patientId: 'p11', fromStatus: 'undispatched', toStatus: 'dispatched', operator: '店长', timestamp: '2026-06-18 15:00:00', note: '多次爽约，重点关注' }] },
  { id: 'p12', name: '何女士', phone: '187****5566', clinicName: '广州天河店', treatmentType: '儿牙', abnormalType: 'suture_unvisited', abnormalDetail: '术后6天未回访', lastVisitDate: '2024-06-12', daysOverdue: 3, noShowCount: 0, status: 'contacted', assignee: '刘芳芳', assigneeStatus: 'processing', dispatchedAt: '2026-06-20 09:00:00', followUpRecords: [{ id: 'f13', patientId: 'p12', fromStatus: 'undispatched', toStatus: 'dispatched', operator: '店长', timestamp: '2026-06-20 09:00:00' }, { id: 'f14', patientId: 'p12', fromStatus: 'dispatched', toStatus: 'processing', operator: '刘芳芳', timestamp: '2026-06-20 14:00:00', note: '家长说孩子考试，下周来' }] },
  { id: 'p13', name: '韩先生', phone: '186****8899', clinicName: '成都锦江店', treatmentType: '种植', abnormalType: 'suture_unvisited', abnormalDetail: '种植术后10天未回访', lastVisitDate: '2024-06-07', daysOverdue: 8, noShowCount: 0, status: 'pending', assignee: '', assigneeStatus: 'undispatched', followUpRecords: [] },
  { id: 'p14', name: '许女士', phone: '185****1122', clinicName: '上海浦东店', treatmentType: '正畸', abnormalType: 'ortho_overdue', abnormalDetail: '正畸复诊超期7周', lastVisitDate: '2024-05-03', daysOverdue: 43, noShowCount: 3, status: 'pending', assignee: '王美玲', assigneeStatus: 'dispatched', dispatchedAt: '2026-06-16 10:00:00', followUpRecords: [{ id: 'f15', patientId: 'p14', fromStatus: 'undispatched', toStatus: 'dispatched', operator: '店长', timestamp: '2026-06-16 10:00:00' }] },
  { id: 'p15', name: '邓先生', phone: '184****4455', clinicName: '杭州西湖店', treatmentType: '牙周', abnormalType: 'suture_unvisited', abnormalDetail: '术后9天未拆线回访', lastVisitDate: '2024-06-07', daysOverdue: 8, noShowCount: 1, status: 'pending', assignee: '', assigneeStatus: 'undispatched', followUpRecords: [] },
];
